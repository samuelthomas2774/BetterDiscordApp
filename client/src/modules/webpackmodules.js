...
export default class WebpackModules {
    ...
    static get KnownModules() {
        return this._knownmodules || (this._knownmodules = {
            // React
    ...
    static getModuleByName(name, fallback) {
        ...
        if (this.KnownModules.hasOwnProperty(name)) fallback = this.KnownModules[name];
    ...
    static listKnownModules() {
        return Object.keys(this.KnownModules);
    }
